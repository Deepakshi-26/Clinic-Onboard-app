...
export const translations: Record<Locale, Dict> = {
  en: {
    ...
    "dashboard.newHireRequests": "New Hire Requests",
    "dashboard.proposedStart": "Proposed start:",
    "dashboard.reviewAndInvite": "Review & Invite",
    ...
    "invite.prefilledFromOwner": "Pre-filled from a new hire request submitted by the Owner:",
    ...
    "shell.clinicOwner": "Clinic Owner",
    "shell.ownerFallback": "Owner",

    "nav.addNewHire": "Add New Hire",
    "owner.addHeading": "Add a New Hire",
    "owner.addSubtitle": "Tell HR about a new hire — they'll review it and send the actual portal invite.",
    "owner.fullName": "Full name",
    "owner.fullNamePlaceholder": "Jordan Smith",
    "owner.personalEmail": "Personal email (if known)",
    "owner.personalEmailHint": "HR can add this later if you don't have it yet.",
    "owner.startDate": "Proposed start date",
    "owner.notes": "Notes (optional)",
    "owner.submitButton": "Add New Hire",
    "owner.submitting": "Adding…",
    "owner.submitSuccess": "Sent to HR — they'll take it from here.",
    "owner.submitError": "Couldn't save this. Please try again.",
    "owner.historyHeading": "Your Submissions",
    "owner.historyEmpty": "You haven't added any new hires yet.",
  ...
  fr: {
    ...
    "dashboard.newHireRequests": "Nouvelles demandes d'embauche",
    "dashboard.proposedStart": "Début proposé :",
    "dashboard.reviewAndInvite": "Examiner et inviter",
    ...
    "invite.prefilledFromOwner": "Pré-rempli à partir d'une demande soumise par le propriétaire :",
    ...
    "shell.clinicOwner": "Propriétaire de la clinique",
    "shell.ownerFallback": "Propriétaire",

    "nav.addNewHire": "Ajouter une embauche",
    "owner.addHeading": "Ajouter une nouvelle embauche",
    "owner.addSubtitle": "Informez les RH d'une nouvelle embauche — ils examineront et enverront l'invitation réelle.",
    "owner.fullName": "Nom complet",
    "owner.fullNamePlaceholder": "Jordan Smith",
    "owner.personalEmail": "Courriel personnel (si connu)",
    "owner.personalEmailHint": "Les RH peuvent l'ajouter plus tard si vous ne l'avez pas encore.",
    "owner.startDate": "Date de début proposée",
    "owner.notes": "Notes (optionnel)",
    "owner.submitButton": "Ajouter l'embauche",
    "owner.submitting": "Ajout en cours…",
    "owner.submitSuccess": "Envoyé aux RH — ils prennent le relais.",
    "owner.submitError": "Impossible d'enregistrer. Réessayez.",
    "owner.historyHeading": "Vos soumissions",
    "owner.historyEmpty": "Vous n'avez encore ajouté aucune nouvelle embauche.",
