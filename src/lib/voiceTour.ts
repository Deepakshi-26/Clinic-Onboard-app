...
export function buildTourSteps(
  ...
  if (locale === "fr") {
    ...
    return [
      ...
      },
      {
        ...
        narration: `Avant tout, garde tes infos personnelles à jour ici: ton nom, ton téléphone, ta date de naissance, ton adresse, ton numéro d'assurance sociale, ta carte d'assurance maladie, et ton numéro de permis si tu en as un.`,
      ...
      },
      {
        ...
        narration: `Et ici, tes identifiants pour MEDEXA, le logiciel que tu utiliseras au quotidien. Ton mot de passe reste caché par défaut, mais tu peux cliquer sur le cadenas pour le révéler quand tu en as besoin.`,
        href: "/employee/access",
      ...
      },
      {
        ...
        narration: `Et ici, tes identifiants Myle, avec le même cadenas pour révéler le mot de passe.`,
        href: "/employee/access",
        target: "access-myle",
      },
      {
  ...
  return [
    ...
    },
    {
      ...
      narration: `First, keep your personal info current here: your name, phone, date of birth, address, SIN, health card number, and permit number if you have one.`,
      href: "/employee/documents",
      target: "documents-info",
    },
    {
    ...
    },
    {
      ...
      icon: "🔑",
      title: "MEDEXA Login",
      narration: `And here's your MEDEXA login, the practice software you'll use day to day. Your password stays hidden by default, but you can click the lock icon to reveal it whenever you need it.`,
      href: "/employee/access",
      target: "access-medexa",
    },
    {
      ...
      icon: "🔑",
      title: "Myle Login",
      narration: `And here's your Myle login, with the same lock icon to reveal that password too.`,
      href: "/employee/access",
      target: "access-myle",
    },
    {
