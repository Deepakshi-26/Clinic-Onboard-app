...
export function buildTourSteps(employee: Employee, locale: Locale): TourStep[] {
  ...
  if (locale === "fr") {
    return [
      ...
      },
      {
        ...
        narration: `Enfin, tes identifiants Myle. Une chose de moins à te soucier.`,
        href: "/employee/access",
        target: "access-myle",
      },
      {
        ...
        icon: "📋",
        title: "Mes documents",
        narration: `Ici, tu peux téléverser tes documents personnels — comme un chèque spécimen ou une preuve d'identité — que les RH t'ont demandés. Tu y es presque, bon travail.`,
      ...
      },
      {
        ...
        icon: "💬",
        title: "Messages",
        narration: `Besoin de parler aux RH ou à un collègue qui s'intègre en même temps que toi? C'est ici. Tu n'es jamais seul ici.`,
  ...
  return [
    ...
    },
    {
      ...
      icon: "🔑",
      title: "Myle Login",
      narration: `Last one on this page, your Myle login. One less thing to worry about.`,
      href: "/employee/access",
      target: "access-myle",
    },
    {
      ...
      icon: "📋",
      title: "My Documents",
      narration: `Here's where you upload your personal documents — like a void cheque or ID — that HR has asked you for. Almost there — nice work.`,
      href: "/employee/documents",
      target: "documents-upload",
    },
    {
    ...
    },
    {
      ...
      icon: "💬",
      title: "Messages",
      narration: `Need to reach HR, or a coworker who's onboarding at the same time as you? This is the place. You're never on your own here.`,
      href: "/employee/messages",
      target: "messages-support",
    },
    {
