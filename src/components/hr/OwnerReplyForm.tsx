...
import { sendOwnerMessage } from "@/app/hr/messages/actions";
import { useLocale } from "@/lib/i18n/LocaleProvider";
import { MicButton } from "@/components/messages/MicButton";

export function OwnerReplyForm({ ownerId }: { ownerId: string }) {
  const { t } = useLocale();
    ...
    <div className="mt-3">
      ...
      <div className="flex gap-1.5">
        ...
        <input
          ...
          placeholder={t("messages.typeYourReply")}
